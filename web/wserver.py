...
<body>
  <!--© Designed and coded by @invisiblemahn-Telegram-->
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/invisiblemahn">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/foevil/Mirror"><i class="fab fa-github"></i></a>
        <a href="https://t.me/invisiblemahn"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>See mirror-with-weeb <a href='https://github.com/foevil/Mirror'>@GitHub</a> By <a href='https://github.com/Foevil'>Code With Mirror</a></h1>"
